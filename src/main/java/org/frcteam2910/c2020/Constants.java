...
public class Constants
{
    ...
    public static final double ENCODER_TICKS_PER_MAG_REVOLUTION = 4096.0;
    ...
    public static final double ARM_ROTATOR_ONE_REVOLUTION_TO_EXTERNAL_ENCODER_TICKS = ARM_ROTATOR_EXTERNAL_ENCODER_RATIO*Constants.ENCODER_TICKS_PER_MAG_REVOLUTION;
